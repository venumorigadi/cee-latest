                    ...
                    <tr>
                        ...
                        <td>
                            <select name="uploadingContext" id="selectContext" onchange="javascript:makeUrl();" style="width:218px;">
                                ...
                                <option value="processLagoVistaData">Lago Vista</option>
                                <option value="processFortWorthData">Fort Worth</option>
                                <option value="processCounty1">Harris</option>
                                <option value="processCounty2">Richardson</option>
                                <option value="processCounty3">Grand Praire</option>
                                <option value="processCounty4">Montgomery</option>
                            </select>
                        </td>
                        <tr>
                            <td></td>
